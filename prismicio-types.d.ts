...
/**
 * Primary content in *ExtendedTextBlock → Primary*
 */
export interface ExperienceSliceDefaultPrimary {
  /**
   * Heading field in *ExtendedTextBlock → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
...
/**
 * Primary content in *ExtendedTextBlock → Items*
 */
export interface ExperienceSliceDefaultItem {
  /**
   * Title field in *ExtendedTextBlock → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Time Period field in *ExtendedTextBlock → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Institution field in *ExtendedTextBlock → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
  ...
  /**
   * Description field in *ExtendedTextBlock → Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
...
/**
 * Default variation for ExtendedTextBlock Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
/**
 * Slice variation for *ExtendedTextBlock*
 */
type ExperienceSliceVariation = ExperienceSliceDefault;

/**
 * ExtendedTextBlock Shared Slice
 *
 * - **API ID**: `experience`
 ...
 */
export interface TListSliceDefaultPrimary {
  /**
   * Heading field in *TechList → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: t_list.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;
}
 ...
 */
export interface TListSliceDefaultItem {
  /**
   * Tech Name field in *TechList → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: t_list.items[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
   ...
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: t_list.items[].tech_color
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TListSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<TListSliceDefaultPrimary>,
  Simplify<TListSliceDefaultItem>
>;

/**
 * Slice variation for *TechList*
 */
type TListSliceVariation = TListSliceDefault;
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type TListSlice = prismic.SharedSlice<"t_list", TListSliceVariation>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TListSlice,
      TListSliceDefaultPrimary,
      TListSliceDefaultItem,
      TListSliceVariation,
      TListSliceDefault,
      TextBlockSlice,
